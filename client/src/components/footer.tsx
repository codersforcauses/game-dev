...
export function Footer() {
  ...
  const mainLinks = [{ label: "Home", href: "/", icon: <Zap className="w-4 h-4" /> }, { label: "About", href: "/about", icon: <Users className="w-4 h-4" /> }, { label: "Events", href: "/events", icon: <Calendar className="w-4 h-4" /> }, { label: "Games", href: "/games", icon: <Gamepad2 className="w-4 h-4" /> }, { label: "Artwork", href: "/artwork", icon: <Palette className="w-4 h-4" /> }];
  const socialLinks = [
    ...
    <div className="relative z-10 border-t border-purple-500/20">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link
            href="/constitution"
            className="group flex items-center gap-2.5 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 sm:self-center sm:-mt-6"
          >
