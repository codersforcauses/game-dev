    ...
    <div className="container mx-auto py-10">
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-1/2 left-[-50px] z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-dark-3 text-white shadow-md hover:bg-accent disabled:opacity-30"
        >
          <ChevronLeft size={30} />
        </button>
        ...
        <button
          ...
          className="absolute top-1/2 right-[-50px] z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-dark-3 text-white shadow-md hover:bg-accent disabled:opacity-30"
        >
