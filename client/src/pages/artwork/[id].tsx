              ...
              >
                <div data-layer="Frame 1163" className="Frame1163 relative">
                  <div
                    ...
                    className="Contributors text-light-3 justify-start font-['Jersey_10'] text-6xl font-normal leading-[76px] tracking-wide"
                  >
                    Contributors
                  </div>
                </div>
      ...
      <div data-layer="Frame 1101" className="Frame1101 bg-slate-950 py-10">
        ...
        >
          <Image
            alt="Game Image"
            data-layer="image 15"
            className="Image15 h-96"
            src="https://placehold.co/1293x405"
          />
        </div>
      </div>
      <div
