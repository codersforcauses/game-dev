...
export default function FeaturedArtwork({ carousels = [] }: ArtworksPageProps) {
  return (
    <div className="bg-gamedev-dark min-h-screen overflow-x-hidden">
      <section className="flex flex-col items-center bg-muted px-12 pt-12 pb-16 sm:pb-12 md:px-24">
        <h1 className="text-center font-jersey10 text-6xl leading-[76px] font-bold tracking-wide text-primary">
          Featured Artwork
        </h1>
      ...
      <section className="-mt-8 [overflow:clip] bg-gradient-to-b from-dark-3 to-dark-alt py-8 [clip-path:polygon(0%_0%,20%_0%,calc(20%+32px)_32px,100%_32px,100%_100%,0%_100%)]">
