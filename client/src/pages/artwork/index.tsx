    ...
    <ImageCard
      ...
      backContent={
        <div className="flex h-full flex-col gap-4">
          ...
          <Link
            href={`/artwork/${artwork.id}`}
            className="mt-4 rounded-md border border-accent bg-accent/10 px-4 py-2 text-center font-jersey10 text-lg text-accent transition-colors hover:bg-accent hover:text-dark_3"
