          ...
          <div className="flex h-full flex-col gap-4">
            ...
            {artwork.contributors.length > 0 && (
              <div className="mt-auto">
                <h4 className="mb-4 font-jersey10 text-3xl text-accent">
                  Contributors
                </h4>
                <div className="space-y-3">
                  {artwork.contributors.map((contributor) => (
                    <div
                      key={contributor.id}
                      className="flex items-center justify-between font-dmSans text-base text-light_1"
                    >
                      <span className="pl-2">{contributor.member_name}</span>
